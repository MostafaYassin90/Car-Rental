...
import user_profile_default from "./user_profile_default.png";

export const cityList = ["New York", "Los Angeles", "Houston", "Chicago"];
export const carCategory = ["Sedan", "SUV", "Van"];
export const carTransmission = ["Automatic", "Manual", "Semi-Automatic"];
export const carFuelType = ["Gas", "Diesel", "Petrol", "Electric", " Hybrid"];
